...
export function HelpPage() {
	return <Modal style={{padding: "32px"}}>
		...
		<p>Custom weapons are curretly supported through the <a href="https://rotmg-mirror.github.io/rotmg-sandbox" target="_blank" rel="noreferrer">sandbox.</a>. Right click on any item in your inventory, then click Copy to edit it.</p>
